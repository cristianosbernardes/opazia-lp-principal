        ...
        <AnimatedSection className="py-20 sm:py-28">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-foreground sm:text-4xl">Você reconhece esses problemas?</h2>
                    <p className="mt-4 text-muted-foreground">Se sim, o Opazia foi feito para você.</p>
                </div>
                ...
                <div className="mt-14 grid gap-6 sm:grid-cols-3">
                    {painPoints.map((pain, i) => (
                        ...
                        >
                            ...
                            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{pain.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
