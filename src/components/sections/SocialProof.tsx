            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="rounded border border-border bg-gradient-to-br from-primary/10 via-sidebar-accent to-sidebar-accent p-10 sm:p-16">
                    <div className="text-center">
                        <h2 className="text-3xl font-bold text-foreground sm:text-4xl">Resultados que falam por si</h2>
                        <p className="mt-4 text-muted-foreground">Números reais de quem usa o Opazia.</p>
                    </div>
