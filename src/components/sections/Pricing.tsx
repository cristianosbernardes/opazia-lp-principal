        ...
        <AnimatedSection id="planos" className="py-20 sm:py-28">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <h2 className="text-3xl font-bold text-foreground sm:text-4xl">Escolha o plano ideal para o seu negócio</h2>
                    <p className="mt-4 text-muted-foreground">Todos os planos incluem 7 dias de trial gratuito.</p>
                </div>
                    ...
                    {plansList.map((plan, i) => (
                        ...
                        >
                            ...
                            <div className="-mx-6 -mt-6 mb-6 rounded-t border-b border-border/40 bg-muted/5 p-6 pb-4">
                                <h3 className="text-lg font-semibold text-foreground uppercase">{plan.name}</h3>
