            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 sm:flex-row">
                    ...
                    <div className="flex gap-4">
                        <a href="#" aria-label="Instagram" className="text-sidebar-foreground/40 hover:text-primary transition-colors"><Instagram className="h-5 w-5" /></a>
                        <a href="#" aria-label="LinkedIn" className="text-sidebar-foreground/40 hover:text-primary transition-colors"><Linkedin className="h-5 w-5" /></a>
                        <a href="#" aria-label="E-mail" className="text-sidebar-foreground/40 hover:text-primary transition-colors"><Mail className="h-5 w-5" /></a>
                    </div>
                </div>
            </div>
        </footer>
